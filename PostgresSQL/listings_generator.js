...
reservationsStream.write('listing_id,reservation_checkin,reservation_checkout,reservation_adults,reservation_children,reservation_totalCost,listing_service,User_id  \n');
...
function listingsGenerator(numberOfListings) {
  ...
  for (let i = 0; i < reservations.length; i++) {
    let reservation_entry = `${reservations[i].listing},${reservations[i].checkin},${reservations[i].checkout},${reservations[i].adults},${reservations[i].children},${reservations[i].infants},${reservations[i].totalCost},${reservations[i].guestId}\n`;
